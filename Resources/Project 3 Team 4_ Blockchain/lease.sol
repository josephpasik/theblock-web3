/* 
Source: https://medium.com/@naqvi.jafar91/converting-a-property-rental-paper-contract-into-a-smart-contract-daa054fdf8a7
*/
...
/*****************************************
https://github.com/anudishjain/CharterContracts/blob/master/Smart%20Contracts/MainContract.sol
@author- Anudish Jain
******************************************/
...
contract Rent is Owned {
	...
	function registerParties(address _tenant) external 	{
		...
		if(checkUser[msg.sender] == true)
		{
			...
			{
				registerParty('Tenant is not registered on Charter');
			}
		}
